...
const gameDay: FabricTemplate = {
  ...
  defaults: {
    ...
    team_id: "",
    lineup: [
      { jersey: "10", name: "FIRST LAST", position: "QB" },
      { jersey: "22", name: "FIRST LAST", position: "RB" },
      { jersey: "7", name: "FIRST LAST", position: "WR" },
      { jersey: "84", name: "FIRST LAST", position: "TE" },
      { jersey: "55", name: "FIRST LAST", position: "OL" },
    ],
  },
  build: (v, b) => {
    const p = palette(b);
